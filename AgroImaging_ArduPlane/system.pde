...
static void init_ardupilot()
{
    ...
    //init_rc_in();               // sets up rc channels from radio  // agro
    //init_rc_out();              // sets up the timer libs   // agro
...
static void startup_ground(void)
{
    ...
    // ---------------------------
    // trim_radio();               // This was commented out as a HACK.  Why?  I don't find a problem.  // agro
